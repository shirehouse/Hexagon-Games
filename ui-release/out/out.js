...
var Main = /** @class */ (function () {
    ...
    Main.onReady = function () {
        ...
        this.terrian = new terrain_1.Terrain(this.canvas.width, this.canvas.height, 60);
...
var Terrain = /** @class */ (function () {
    function Terrain(Width, Height, Size) {
        this.Width = Width;
        this.Height = Height;
        this.Size = Size;
    ...
    Terrain.prototype.getPos = function (r, c) {
        ...
        var y = this.center.y - this.hHalf - r * (this.CellHeight - this.h4th);
        var l = new Point(x, y);
        return l;
    };
