...
var main_1 = require("./menu/main");
console.log('main...');
main_1.Main.main();

},{"./menu/main":2}],2:[function(require,module,exports){
"use strict";
...
var Main = /** @class */ (function () {
    ...
    Main.onReady = function () {
        var _this = this;
        var c = jquery_1.default("#canvas");
        this.canvas = c[0];
        this.load = jquery_1.default("#load");
        this.terrian = new terrain_1.Terrain(this.canvas.width, this.canvas.height, 60, 60);
...
},{"../terrain/terrain":3,"jquery":4}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Terrain = /** @class */ (function () {
    function Terrain(Width, Height, CellWidth, CellHeight) {
        this.Width = Width;
        this.Height = Height;
        ...
        var midX = Math.floor(this.Height / 2);
        var midY = Math.floor(this.Width / 2);
        this.center = new Point(midX, midY);
    }
    Terrain.prototype.drawHex = function (ctx, x, y) {
    ...
    Terrain.prototype.getPos = function (r, c) {
        var xOff = Math.abs(r) % 2;
        var shiftRight = Math.floor(r / 2);
        if (r < 0) {
            shiftRight = -1 * Math.floor(Math.abs(r / 2)) - xOff;
        }
        var x = this.center.x - this.wHalf + xOff * this.wHalf + (c + shiftRight) * this.CellWidth;
        var y = this.center.y - this.hHalf - r * this.h3rd * 2;
        var l = new Point(x, y);
        return l;
    };
    ...
    Terrain.prototype.render = function (ctx) {
        ctx.strokeStyle = "#000000";
        //ctx.lineWidth = 1;
        var pOffset = new Point(this.wHalf, this.hHalf);
        for (var r = -10; r <= 10; r++) {
            for (var c = -10; c <= 10; c++) {
                var p = this.getPos(r, c);
                p.add(pOffset);
